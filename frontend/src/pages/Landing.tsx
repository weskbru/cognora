    ...
    pricing: {
      ...
      plans: [
        { name: 'Free', price: 'R$0', period: 'para sempre', desc: 'Para começar sem compromisso.',
          features: ['3 matérias','1 PDF por matéria','3 PDFs ativos','Upload até 5 MB','5 resumos, 5 questões e 5 flashcards/mês','1 competição ativa'],
        ...
        { name: 'Pro', price: 'R$9,90', period: '/mês', badge: 'Mais popular', desc: 'Para quem estuda de verdade.',
          features: ['10 matérias','2 PDFs por matéria','20 PDFs ativos','Upload até 25 MB','30 resumos, 30 questões e 30 flashcards/mês','5 competições ativas'],
          nope: [] as string[], cta: 'Assinar Pro' },
        { name: 'Premium', price: 'R$19,90', period: '/mês', desc: 'Uso intensivo com limites altos.',
          features: ['30 matérias','5 PDFs por matéria','100 PDFs ativos','Upload até 50 MB','100 resumos, 100 questões e 100 flashcards/mês','20 competições ativas'],
          nope: [] as string[], cta: 'Assinar Premium' },
      ],
    },
    testimonials: {
    ...
    pricing: {
      ...
      plans: [
        { name: 'Free', price: '$0', period: 'forever', desc: 'Start with no commitment.',
          features: ['3 subjects','1 PDF per subject','3 active PDFs','Upload up to 5 MB','5 summaries, 5 question runs and 5 flashcard runs/month','1 active competition'],
        ...
        { name: 'Pro', price: '$9.90', period: '/month', badge: 'Most popular', desc: 'For serious students.',
          features: ['10 subjects','2 PDFs per subject','20 active PDFs','Upload up to 25 MB','30 summaries, 30 question runs and 30 flashcard runs/month','5 active competitions'],
          nope: [] as string[], cta: 'Subscribe Pro' },
        { name: 'Premium', price: '$19.90', period: '/month', desc: 'High limits for intensive studying.',
          features: ['30 subjects','5 PDFs per subject','100 active PDFs','Upload up to 50 MB','100 summaries, 100 question runs and 100 flashcard runs/month','20 active competitions'],
          nope: [] as string[], cta: 'Subscribe Premium' },
      ],
    },
    testimonials: {
    ...
    pricing: {
      ...
      plans: [
        { name: 'Free', price: 'R$0', period: 'para siempre', desc: 'Para comenzar sin compromiso.',
          features: ['3 materias','1 PDF por materia','3 PDFs activos','Subida hasta 5 MB','5 resúmenes, 5 generaciones de preguntas y 5 de flashcards/mes','1 competición activa'],
        ...
        { name: 'Pro', price: 'R$9,90', period: '/mes', badge: 'Más popular', desc: 'Para quienes estudian de verdad.',
          features: ['10 materias','2 PDFs por materia','20 PDFs activos','Subida hasta 25 MB','30 resúmenes, 30 generaciones de preguntas y 30 de flashcards/mes','5 competiciones activas'],
          nope: [] as string[], cta: 'Suscribirse Pro' },
        { name: 'Premium', price: 'R$19,90', period: '/mes', desc: 'Uso intensivo con límites altos.',
          features: ['30 materias','5 PDFs por materia','100 PDFs activos','Subida hasta 50 MB','100 resúmenes, 100 generaciones de preguntas y 100 de flashcards/mes','20 competiciones activas'],
          nope: [] as string[], cta: 'Suscribirse Premium' },
      ],
    },
    testimonials: {
