...
def _run_migrations():
    ...
    migrations = [
        ...
        "CREATE INDEX IF NOT EXISTS ix_ai_generation_jobs_user_email ON ai_generation_jobs (user_email)",
        "CREATE INDEX IF NOT EXISTS ix_ai_generation_jobs_document_id ON ai_generation_jobs (document_id)",
        "CREATE INDEX IF NOT EXISTS ix_ai_generation_jobs_operation ON ai_generation_jobs (operation)",
